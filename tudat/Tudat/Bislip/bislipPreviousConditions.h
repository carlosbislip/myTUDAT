#ifndef BISLIPPREVIOUSCONDITIONS_H
#define BISLIPPREVIOUSCONDITIONS_H
...
public:
     ...
     */
    PreviousConditions( const double landingMass = 0 ):
...
*/
    ...
    std::map < int, Eigen::VectorXd > setDensityParameterMapForJerk( )
    {
...
#endif // BISLIPPREVIOUSCONDITIONS_H
