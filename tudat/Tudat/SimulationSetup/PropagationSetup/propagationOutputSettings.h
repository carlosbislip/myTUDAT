...
enum PropagationDependentVariables
{
    ...
    specific_energy                                      = 45,
    normalized_specific_energy                           = 46,
    evaluated_throttle_setting                           = 47,
    evaluated_thrust_elevation_angle                     = 48,
    evaluated_thrust_azimuth_angle                       = 49,
    evaluated_angle_of_attack                            = 50,
    evaluated_bank_angle                                 = 51,
    current_mass                                         = 52,
    engine_status                                        = 53,
    angular_distance_traveled                            = 54,
    angular_distance_to_go                               = 55,
    heading_to_target                                    = 56,
    heading_error                                        = 57,
    heat_flux_tauber                                     = 58,
    body_fixed_thrust_vector                             = 59,
    bending_moment                                       = 60,
    local_gravity                                        = 61,
    skip_suppression_limit                               = 62,
    bodyflap_deflection_moment_coefficient_increment     = 63,
    bodyflap_deflection_moment_coefficient_increment_dif = 64,
    body_fixed_total_load_vector                         = 65,
    body_fixed_total_g_load_vector                       = 66,
    body_fixed_total_g_load_magnitude                    = 67,
    body_fixed_aero_load_vector                          = 68,
    bank_reversal_trigger                                = 69,
    heat_flux_chapman                                    = 70,
    passenger_fixed_total_g_load_vector                  = 71,
    commanded_throttle_setting                           = 72,
    commanded_thrust_elevation_angle                     = 73,
    commanded_thrust_azimuth_angle                       = 74,
    commanded_angle_of_attack                            = 75,
    commanded_bank_angle                                 = 76,
    current_lift_magnitude                               = 77,
    current_heading_error_deadband                       = 78,
    reversal_conditional                                 = 79,
    wall_temperature_chapman                             = 80,
    wall_temperature_tauber_stagnation                   = 81,
    wall_temperature_tauber_flatplate                    = 82,
    heat_flux_tauber_stagnation                          = 83,
    heat_flux_tauber_flatplate                           = 84,
    temp_bank_angle                                      = 85,
    cumulative_angular_distance_travelled                = 86,
    groundtrack_difference                               = 87,
    time_of_flight                                       = 88,
    flight_path_angle_rate                               = 89,
    cumulative_cartesian_distance_travelled              = 90,
    thrust_force_magnitude                               = 91,
    speed_of_sound                                       = 92,
    adiabatic_wall_temperature                           = 93,
    freestream_temperature                               = 94,
    current_drag_magnitude                               = 95,
    estimated_flight_path_angle                          = 96,
    aerodynamic_frame_aerodynamic_load_vector            = 97,
    aerodynamic_frame_total_load_vector                  = 98,
    aerodynamic_frame_total_acceleration_vector          = 99,
    passenger_frame_total_load_vector                    = 100,
    passenger_frame_total_acceleration_vector            = 101,
    passenger_frame_jerk_vector                          = 102,
    trajectory_phase                                     = 103,
    height_dependent_variable                            = 104,
    angular_distance_covered_ratio                       = 105
};
