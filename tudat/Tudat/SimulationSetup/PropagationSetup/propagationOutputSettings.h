...
enum PropagationDependentVariables
{
    ...
    specific_energy = 44,
    normalized_specific_energy = 45,
    evaluated_throttle_setting = 46,
    evaluated_thrust_elevation_angle = 47,
    evaluated_thrust_azimuth_angle = 48,
    evaluated_angle_of_attack = 49,
    evaluated_bank_angle = 50,
    current_mass = 51,
    engine_status = 52,
    angular_distance_traveled = 53,
    angular_distance_to_go = 54,
    heading_to_target = 55,
    heading_error = 56,
    heat_flux_tauber = 57,
    body_fixed_thrust_vector = 58,
    bending_moment = 59,
    local_gravity = 60,
    skip_suppression_limit = 61,
    bodyflap_deflection_moment_coefficient_increment = 62,
    bodyflap_deflection_moment_coefficient_increment_dif = 63,
    body_fixed_total_load_vector = 64,
    body_fixed_total_g_load_vector = 65,
    body_fixed_total_g_load_magnitude = 66,
    body_fixed_aero_load_vector = 67,
    bank_reversal_trigger = 68,
    heat_flux_chapman = 69,
    passenger_fixed_total_g_load_vector = 70,
    commanded_throttle_setting = 71,
    commanded_thrust_elevation_angle = 72,
    commanded_thrust_azimuth_angle = 73,
    commanded_angle_of_attack = 74,
    commanded_bank_angle = 75,
    current_lift_magnitude = 76,
    current_heading_error_deadband = 77,
    reversal_conditional = 78,
    wall_temperature_chapman = 79,
    wall_temperature_tauber_stagnation = 80,
    wall_temperature_tauber_flatplate = 81,
    heat_flux_tauber_stagnation = 82,
    heat_flux_tauber_flatplate = 83,
    temp_bank_angle = 84,
    cumulative_angular_distance_travelled = 85,
    groundtrack_difference = 86,
    time_of_flight = 87,
    flight_path_angle_rate = 88,
