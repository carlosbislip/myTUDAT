...
for p = 1:numel(compilation)
    ...
    plotearth('Maptype','bluemarble',...
        'NEOMap',...
        strcat(compilation(p).mainpath,'additionalfunctions/PlotEarth/PlotEarth/BlueMarble.png'),...'/Users/bislip/Cloud Storage/OneDrive/School/TUDelft/Space Flight/Thesis/tudatBundle.git/tudatApplications/Space4ErrBody.git/Space4ErrBody_0/matlab/additionalfunctions/PlotEarth/PlotEarth/BlueMarble.png',...
    ...
    ax.Clipping = 'off';
    hold off
    saveas(figure(fig_num),strcat(compilation(p).mainpath,'/figures/Trajectories_3D_Map_1_Set',convertCharsToStrings(compilation(p).set),'.png'));
